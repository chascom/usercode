...
import sys
#bsub -R "pool>10000" -sp 99 -q 2nd -J bjob1 < Gentest.sh
...
# event source
#DIRR = "file:///afs/cern.ch/work/c/chasco/CMSSW_5_3_11/src/zllHinv_PythiaCard/ZHToLLInv_M135_8TeV_evts500k/"
process.source = cms.Source("PoolSource",fileNames = cms.untracked.vstring())
#process.PoolSource.fileNames=[DIRR+"Events_0000.root"]#inputList
process.PoolSource.fileNames=[THEINPUTFILE]
#process.source.fileNames += DIRR+"Events_0000.root",
#process.source.fileNames += DIRR+"Events_0001.root",
process.maxEvents = cms.untracked.PSet( input = cms.untracked.int32(-1) )
runOnMC = True
runStd = True
runFull = True
outFile = "ntuple_"+THEINPUTFILE.split("/")[-1].split(":")[-1]
# global tag
