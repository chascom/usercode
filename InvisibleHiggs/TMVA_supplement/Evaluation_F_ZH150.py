...
discriminatingvariables = ['BDTZH150','LikelihoodZH150','BDTZZ','LikelihoodZZ'] #Discriminating variables, in order, used for the TMVA
...
#discriminatingvariables = ['LikelihoodZH105','BDTFUSION_ZZ_ZH']
methods = ['BDT','Likelihood']  # METHOD Used

fdir = directory + '/ZH105_vs_ALL/ZH115_vs_ALL/ZH125_vs_ALL/' #Where your root files are kept
tag = 'ZH150_vs_ALL'  # Tag to name your new directory of root files. DO NOT LEAVE BLANK
...
signal_tag = 'F_ZH150' # This identifies which files are signal. Should be in each signal file name above. 
