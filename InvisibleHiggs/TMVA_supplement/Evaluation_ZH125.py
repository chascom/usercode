...
discriminatingvariables = discriminatingvariable_set3
#discriminatingvariables = ['TransMass_ZH125','THRUST_2D','L1_L2_cosangle','DeltaPhi_ZH','CS_cosangle','Pt_L2','CMAngle','Z_rapidity_z','Pt_L1','DeltaPhi_L1H','PFMET_PT'] #Discriminating variables, in order, used for the TMVA
...
fdir = directory + '/ZH105_vs_ZZ/ZH115_vs_ZZ/' #Where your root files are kept
tag = 'ZH125_vs_ZZ'  # Tag to name your new directory of root files. DO NOT LEAVE BLANK
...
signal_tag = 'ZH125' # This identifies which files are signal. Should be in each signal file name above. 
