...
discriminatingvariables = ['BDTZH105','LikelihoodZH105','BDTZZ','LikelihoodZZ'] #Discriminating variables, in order, used for the TMVA
...
tag = 'ZH105_vs_ALL'  # Tag to name your new directory of root files. DO NOT LEAVE BLANK
...
signal_tag = 'F_ZH105' # This identifies which files are signal. Should be in each signal file name above. 
