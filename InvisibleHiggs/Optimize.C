...
void ReducedMET(TString Preselection, TString LEPTON_TYPE,TString OptimizedVariable,float EfficiencyMin, float SoverSqrtBMin){	
	...
	TH1F* h_MC_SingleTbar_s = new TH1F("h_MC_SingleTbar_s","title",1,0,2);
	h_MC_SingleTbar_s->Sumw2();
	TH1F* h_MC_SingleTbar_t = new TH1F("h_MC_SingleTbar_t","title",1,0,2);
	h_MC_SingleTbar_t->Sumw2();
	TH1F* h_MC_SingleTbar_tW = new TH1F("h_MC_SingleTbar_tW","title",1,0,2);
	h_MC_SingleTbar_tW->Sumw2();
	TH1F* h_MC_SingleT_s = new TH1F("h_MC_SingleT_s","title",1,0,2);
	h_MC_SingleT_s->Sumw2();
	TH1F* h_MC_SingleT_t = new TH1F("h_MC_SingleT_t","title",1,0,2);
	h_MC_SingleT_t->Sumw2();
	TH1F* h_MC_SingleT_tW = new TH1F("h_MC_SingleT_tW","title",1,0,2);
	h_MC_SingleT_tW->Sumw2();
	TH1F* h_MC_TTJets = new TH1F("h_MC_TTJets","title",1,0,2);
	h_MC_TTJets->Sumw2();
	TH1F* h_MC_WJetsToLNu = new TH1F("h_MC_WJetsToLNu","title",1,0,2);
	h_MC_WJetsToLNu->Sumw2();
	TH1F* h_MC_WW = new TH1F("h_MC_WW","title",1,0,2);
	h_MC_WW->Sumw2();
	TH1F* h_MC_WZ_0 = new TH1F("h_MC_WZ_0","title",1,0,2);
	h_MC_WZ_0->Sumw2();
	TH1F* h_MC_WZ_1 = new TH1F("h_MC_WZ_1","title",1,0,2);
	h_MC_WZ_1->Sumw2();
	...
	MC_SingleTbar_s_tree->Project("h_MC_SingleTbar_s","1",Preselection);
	MC_SingleTbar_t_tree->Project("h_MC_SingleTbar_t","1",Preselection);
	MC_SingleTbar_tW_tree->Project("h_MC_SingleTbar_tW","1",Preselection);
	MC_SingleT_s_tree->Project("h_MC_SingleT_s","1",Preselection);
	MC_SingleT_t_tree->Project("h_MC_SingleT_t","1",Preselection);
	MC_SingleT_tW_tree->Project("h_MC_SingleT_tW","1",Preselection);
	MC_TTJets_tree->Project("h_MC_TTJets","1",Preselection);
	MC_WJetsToLNu_tree->Project("h_MC_WJetsToLNu","1",Preselection);
	MC_WW_tree->Project("h_MC_WW","1",Preselection);
	MC_WZ_0_tree->Project("h_MC_WZ_0","1",Preselection);
	MC_WZ_1_tree->Project("h_MC_WZ_1","1",Preselection);
	...
	float N_MC_SingleTbar_s = h_MC_SingleTbar_s->Integral();
	float N_MC_SingleTbar_t = h_MC_SingleTbar_t->Integral();
	float N_MC_SingleTbar_tW = h_MC_SingleTbar_tW->Integral();
	float N_MC_SingleT_s = h_MC_SingleT_s->Integral();
	float N_MC_SingleT_t = h_MC_SingleT_t->Integral();
	float N_MC_SingleT_tW = h_MC_SingleT_tW->Integral();
	float N_MC_TTJets = h_MC_TTJets->Integral();
	float N_MC_WJetsToLNu = h_MC_WJetsToLNu->Integral();
	float N_MC_WW = h_MC_WW->Integral();
	float N_MC_WZ_0 = h_MC_WZ_0->Integral();
	float N_MC_WZ_1 = h_MC_WZ_1->Integral();
	...
	float bkgd = N_MC_DYJetsToLL_0 + N_MC_DYJetsToLL_1 + N_MC_DYJetsToLL_2 + N_MC_DYJetsToLL_3 + N_MC_DYJetsToLL_4 + N_MC_DYJetsToLL_5 + N_MC_DYJetsToLL_6 + N_MC_DYJetsToLL_7 + N_MC_DYJetsToLL_8 + N_MC_DYJetsToLL_9 + N_MC_SingleTbar_s + N_MC_SingleTbar_t + N_MC_SingleTbar_tW + N_MC_SingleT_s + N_MC_SingleT_t + N_MC_SingleT_tW + N_MC_TTJets + N_MC_WJetsToLNu + N_MC_WW + N_MC_WZ_0 + N_MC_WZ_1; //bkgd =
...
std::cout<<opt_simp<<std::endl;
					...
					MC_SingleTbar_s_tree->Project("h_MC_SingleTbar_s","1",Preselection+TMET);
					MC_SingleTbar_t_tree->Project("h_MC_SingleTbar_t","1",Preselection+TMET);
					MC_SingleTbar_tW_tree->Project("h_MC_SingleTbar_tW","1",Preselection+TMET);
					MC_SingleT_s_tree->Project("h_MC_SingleT_s","1",Preselection+TMET);
					MC_SingleT_t_tree->Project("h_MC_SingleT_t","1",Preselection+TMET);
					MC_SingleT_tW_tree->Project("h_MC_SingleT_tW","1",Preselection+TMET);
					MC_TTJets_tree->Project("h_MC_TTJets","1",Preselection+TMET);
					MC_WJetsToLNu_tree->Project("h_MC_WJetsToLNu","1",Preselection+TMET);
					MC_WW_tree->Project("h_MC_WW","1",Preselection+TMET);
					MC_WZ_0_tree->Project("h_MC_WZ_0","1",Preselection+TMET);
					MC_WZ_1_tree->Project("h_MC_WZ_1","1",Preselection+TMET);
					...
					float Ncut_MC_SingleTbar_s = h_MC_SingleTbar_s->Integral();
					float Ncut_MC_SingleTbar_t = h_MC_SingleTbar_t->Integral();
					float Ncut_MC_SingleTbar_tW = h_MC_SingleTbar_tW->Integral();
					float Ncut_MC_SingleT_s = h_MC_SingleT_s->Integral();
					float Ncut_MC_SingleT_t = h_MC_SingleT_t->Integral();
					float Ncut_MC_SingleT_tW = h_MC_SingleT_tW->Integral();
					float Ncut_MC_TTJets = h_MC_TTJets->Integral();
					float Ncut_MC_WJetsToLNu = h_MC_WJetsToLNu->Integral();
					float Ncut_MC_WW = h_MC_WW->Integral();
					float Ncut_MC_WZ_0 = h_MC_WZ_0->Integral();
					float Ncut_MC_WZ_1 = h_MC_WZ_1->Integral();
					...
					float bkgdcut = Ncut_MC_DYJetsToLL_0 + Ncut_MC_DYJetsToLL_1 + Ncut_MC_DYJetsToLL_2 + Ncut_MC_DYJetsToLL_3 + Ncut_MC_DYJetsToLL_4 + Ncut_MC_DYJetsToLL_5 + Ncut_MC_DYJetsToLL_6 + Ncut_MC_DYJetsToLL_7 + Ncut_MC_DYJetsToLL_8 + Ncut_MC_DYJetsToLL_9 + Ncut_MC_SingleTbar_s + Ncut_MC_SingleTbar_t + Ncut_MC_SingleTbar_tW + Ncut_MC_SingleT_s + Ncut_MC_SingleT_t + Ncut_MC_SingleT_tW + Ncut_MC_TTJets + Ncut_MC_WJetsToLNu + Ncut_MC_WW + Ncut_MC_WZ_0 + Ncut_MC_WZ_1; //float bkgdcut = 
					...
					//else
					//{
					float sig2ncut = sigcut/sqrt(bkgdcut);
...
zzgr1->SetTitle("Sig Eff vs Sig/sqrt(B)");
zzgr1->GetXaxis()->SetTitle("Signal/sqrt(Bkgd)");
...
ReducedMET(Preselection_Zdimuons,"MUON","d0",0.3,0.4); //MUONS
ReducedMET(Preselection_Zdielectrons,"ELEC","d0",0.35,0.4); //ELECTRONS
ReducedMET(Preselection_Z,"BOTH","d0",0.35,0.4);
