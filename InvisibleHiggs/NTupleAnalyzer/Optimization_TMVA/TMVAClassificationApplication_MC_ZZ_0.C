...
Float_t Z_Pz;
reader->AddVariable("Z_Pz",&Z_Pz);

Float_t THRUST_3D;
reader->AddVariable("THRUST_3D",&THRUST_3D);

Float_t Z_rapidity_z_TMVA;
reader->AddVariable("Z_rapidity_z_TMVA",&Z_rapidity_z_TMVA);

Float_t L1_L2_cosangle_TMVA;
reader->AddVariable("L1_L2_cosangle_TMVA",&L1_L2_cosangle_TMVA);

Float_t redMETd0_muon_DYZZ_TMVA;
reader->AddVariable("redMETd0_muon_DYZZ_TMVA",&redMETd0_muon_DYZZ_TMVA);
...
//      reader->AddSpectator( "Category_cat3 := (var3>0)&&(var4>=0)", &Category_cat3 );
 ...
 float nonsense =0;
   ...
   //   
   TFile *input(0);
   TString fname = "/tmp/chasco/ORIGINAL//Data_DoubleMu2011B_1.root";   
...
theTree->SetBranchAddress( " Z_Pz", &Z_Pz);

theTree->SetBranchAddress( " THRUST_3D", &THRUST_3D);

theTree->SetBranchAddress( " Z_rapidity_z_TMVA", &Z_rapidity_z_TMVA);

theTree->SetBranchAddress( " L1_L2_cosangle_TMVA", &L1_L2_cosangle_TMVA);

theTree->SetBranchAddress( " redMETd0_muon_DYZZ_TMVA", &redMETd0_muon_DYZZ_TMVA);
...
vecVar[2]=Z_rapidity_z_TMVA;

vecVar[3]=L1_L2_cosangle_TMVA;

vecVar[4]=redMETd0_muon_DYZZ_TMVA;
         for (std::map<std::string,int>::iterator it = Use.begin(); it != Use.end(); it++) {
            if (it->second) {
