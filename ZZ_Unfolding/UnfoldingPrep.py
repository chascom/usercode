...
# WHICH ENERGY?
TeV8 = True
# outputdir="/afs/cern.ch/work/c/chasco/UNFOLD"
...
initdir = '/afs/cern.ch/work/c/chasco/RJS/CMSSW_5_3_3_patch2/src/CMGTools/HtoZZ2l2nu/test/results/UNFOLDWZ/'
indir = initdir + 'HADD/' 
outdir = indir + 'UnfoldInput/'

if "hadd" in hadder:
	os.system('rm -r '+initdir+'HADD')
...
os.system("hadd "+outdir+"Data8H.root "+outdir+"Data8TeV*.root")
