...
def REBIN(Histo1):
	#newBins = array.array("d",[40., 100., 200., 400., 1000.])
	newBins = array.array("d",[40., 60., 80., 100., 200., 400., 1000.])
	Histo = Histo1.Rebin(len(newBins)-1,"hSig",newBins)
	return Histo

def makeComparison(MCGenHisto,MCRecoHisto,hTrue,hDiff,hClose):
	# MCGenHisto = REBIN(MCGenHisto)
	# MCRecoHisto = REBIN(MCRecoHisto)
	# hTrue = REBIN(hTrue)
	# hDiff = REBIN(hDiff)
	# hClose = REBIN(hClose)
	...
	hDiff.SetMaximum(2.5*hTrue.GetMaximum())
	...
	leg = TLegend(0.7,0.75,0.85,0.87,"","brNDC")
	leg.SetTextFont(132)
	...
	h_comp.SetMinimum(0.7)
	h_comp.SetMaximum(1.3)#1.01*h_comp.GetMaximum())
	...
	h_comp.Draw("e")
	line1 = TLine(40.0,1.0,1000.0,1.0)
	line1.Draw("SAME")
	...
	h_comp3.Print("range")
	h_comp3.Draw("e")
	line2 = TLine(40.0,1.0,1000.0,1.0)
	line2.Draw("SAME")
	...
	h_comp4.Print("range")
	h_comp4.Draw("e")
	line4 = TLine(40.0,1.0,1000.0,1.0)
	line4.Draw("SAME")
	...
	h_comp5.Draw("e")
	line5 = TLine(40.0,1.0,1000.0,1.0)
	line5.Draw("SAME")
