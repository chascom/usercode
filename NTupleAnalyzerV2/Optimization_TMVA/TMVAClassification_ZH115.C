...
factory->AddVariable("REDmet",'F');
   if (ReadDataFromAsciiIFormat) {
      ...
      TTree *signal_ZH115     = (TTree*)input_ZH115->Get("tmvatree");
      ...
      factory->AddSignalTree    ( signal_ZH115,     1.0     );

      factory->AddBackgroundTree( background_ZZ, 1.0 );


      // To give different trees for training and testing, do as follows:
      //    factory->AddSignalTree( signal_ZH115TrainingTree, signal_ZH115TrainWeight, "Training" );

      //    factory->AddSignalTree( signal_ZH115TestTree,     signal_ZH115TestWeight,  "Test" );
