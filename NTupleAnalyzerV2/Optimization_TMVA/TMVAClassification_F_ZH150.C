...
factory->AddVariable("BDTZH150",'F');

factory->AddVariable("LikelihoodZH150",'F');
...
factory->AddVariable("LikelihoodZZ",'F');
   if (ReadDataFromAsciiIFormat) {
      ...
      TTree *signal_F_ZH150     = (TTree*)input_F_ZH150->Get("tmvatree");
      ...
      factory->AddSignalTree    ( signal_F_ZH150,     1.0     );
      ...
      //    factory->AddSignalTree( signal_F_ZH150TrainingTree, signal_F_ZH150TrainWeight, "Training" );

      //    factory->AddSignalTree( signal_F_ZH150TestTree,     signal_F_ZH150TestWeight,  "Test" );
