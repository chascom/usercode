...
factory->AddVariable("REDmet",'F');
   if (ReadDataFromAsciiIFormat) {
      ...
      TTree *signal_ZH135     = (TTree*)input_ZH135->Get("tmvatree");
      ...
      factory->AddSignalTree    ( signal_ZH135,     1.0     );

      factory->AddBackgroundTree( background_ZZ, 1.0 );


      // To give different trees for training and testing, do as follows:
      //    factory->AddSignalTree( signal_ZH135TrainingTree, signal_ZH135TrainWeight, "Training" );

      //    factory->AddSignalTree( signal_ZH135TestTree,     signal_ZH135TestWeight,  "Test" );
