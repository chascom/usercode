...
factory->AddVariable("REDmet",'F');
   if (ReadDataFromAsciiIFormat) {
      ...
      TTree *signal_ZH105     = (TTree*)input_ZH105->Get("tmvatree");
      ...
      factory->AddSignalTree    ( signal_ZH105,     1.0     );

      factory->AddBackgroundTree( background_ZZ, 1.0 );


      // To give different trees for training and testing, do as follows:
      //    factory->AddSignalTree( signal_ZH105TrainingTree, signal_ZH105TrainWeight, "Training" );

      //    factory->AddSignalTree( signal_ZH105TestTree,     signal_ZH105TestWeight,  "Test" );
