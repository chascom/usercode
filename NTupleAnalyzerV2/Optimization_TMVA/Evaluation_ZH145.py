...
discriminatingvariables = discriminatingvariable_set4
#discriminatingvariables = ['TransMass_ZH150','THRUST_2D','L1_L2_cosangle','DeltaPhi_ZH','CS_cosangle','Pt_L2','CMAngle','Z_rapidity_z','Pt_L1','DeltaPhi_L1H','PFMET_PT'] #Discriminating variables, in order, used for the TMVA
...
fdir = directory + '/ZH105_vs_ZZ/ZH115_vs_ZZ/ZH125_vs_ZZ/ZH150_vs_ZZ/ZH135_vs_ZZ/' #Where your root files are kept
if TeV8:
	fdir = fdir.replace('ZH150_vs_ZZ/','')
tag = 'ZH145_vs_ZZ'  # Tag to name your new directory of root files. DO NOT LEAVE BLANK
...
signal_tag = 'ZH145' # This identifies which files are signal. Should be in each signal file name above. 
