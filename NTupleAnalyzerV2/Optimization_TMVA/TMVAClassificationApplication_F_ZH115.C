...
Float_t BDTZH115;
reader->AddVariable("BDTZH115",&BDTZH115);

Float_t LikelihoodZH115;
reader->AddVariable("LikelihoodZH115",&LikelihoodZH115);
...
theTree->SetBranchAddress( " BDTZH115", &BDTZH115);

theTree->SetBranchAddress( " LikelihoodZH115", &LikelihoodZH115);
