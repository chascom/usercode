...
factory->AddVariable("REDmet",'F');
   if (ReadDataFromAsciiIFormat) {
      ...
      TString fname_ZH105_vs_ZZ = "/tmp/chasco/INIT/HADD/TMVA/Trees_FUSION2/ZZ_vs_nonZZ//ZH105_vs_ZZ";
      ...
      TFile *input_ZH105_vs_ZZ = TFile::Open( fname_ZH105_vs_ZZ );
      ...
      std::cout << "--- TMVAClassification       : Using input_ZH105_vs_ZZ file: " << input_ZH105_vs_ZZ->GetName() << std::endl;
      ...
      TTree *signal_ZH105_vs_ZZ     = (TTree*)input_ZH105_vs_ZZ->Get("tmvatree");

      TTree *background_ZH105_vs_ZZ = (TTree*)input_ZH105_vs_ZZ->Get("tmvatree");
      ...
      factory->AddSignalTree    ( signal_ZH105_vs_ZZ,     1.0     );

      factory->AddBackgroundTree( background_ZH105_vs_ZZ, 1.0 );

      factory->AddBackgroundTree( background_ZZ, 1.0 );


      // To give different trees for training and testing, do as follows:
      //    factory->AddSignalTree( signal_ZH105_vs_ZZTrainingTree, signal_ZH105_vs_ZZTrainWeight, "Training" );

      //    factory->AddSignalTree( signal_ZH105_vs_ZZTestTree,     signal_ZH105_vs_ZZTestWeight,  "Test" );
