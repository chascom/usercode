...
D4_NTrees = 4000
D4_MaxDepth = 6
#Combo_string = "_feb7__" + str(D1_NTrees) + "_" + str(D1_MaxDepth) + "_" + str(D2_NTrees) + "_" + str(D2_MaxDepth) + "_" + str(D3_NTrees) + "_" + str(D3_MaxDepth)
Combo_string = "_feb7__SingleD_" + str(D4_NTrees) + "_" + str(D4_MaxDepth)
...
for suff in SystematicSuffixList:
	...
	####################################################################################################################################
	bashprocess.write("rm TMVARoundup.py\n")
	# bashprocess.write("cd /tmp/chasco/INIT/HADD/TMVA/Trees"+suff+"/\n")
	...
	bashprocess.write("echo TMVAround = \\\'D4\\\' > TMVARoundup.py\n") #edit this so it's not shared by other tmva runs
	bashprocess.write("echo String_NTrees = \\\'NTrees="+str(D4_NTrees)+"\\\' >> TMVARoundup.py\n") #500
	bashprocess.write("echo String_MaxDepth = \\\'MaxDepth="+str(D4_MaxDepth)+"\\\' >> TMVARoundup.py\n") #4
	bashprocess.write("echo String_NSmooth = \\\'\\\' >> TMVARoundup.py\n")
	bashprocess.write("echo String_TreeName = \\\'tmvatree\\\' >> TMVARoundup.py\n")
	bashprocess.write("echo directory = \\\'/tmp/chasco/INIT/HADD/TMVA/Trees"+suff+"/\\\' >> TMVARoundup.py\n")
	bashprocess.write("echo discriminatingvariable_set1 = [\\\'CScostheta\\\',\\\'ZRapidity\\\',\\\'phil2met\\\',\\\'ZL1_Boost\\\',\\\'mass\\\',\\\'Theta_lab\\\',\\\'REDmet\\\',\\\'Thrust\\\']  >> TMVARoundup.py\n")
	bashprocess.write("echo discriminatingvariable_set2 = discriminatingvariable_set1 >> TMVARoundup.py\n")
	bashprocess.write("echo discriminatingvariable_set3 = discriminatingvariable_set1 >> TMVARoundup.py\n")
	bashprocess.write("echo discriminatingvariable_set4 = discriminatingvariable_set1 >> TMVARoundup.py\n")
	bashprocess.write("echo discriminatingvariable_set5 = discriminatingvariable_set1 >> TMVARoundup.py\n")
	...
	bashprocess.write("mkdir /afs/cern.ch/work/c/chasco/FINISH_TMVA_XML/Run"+Combo_string+"\n")
	bashprocess.write("cp -r /tmp/chasco/tmva_scratch/ /afs/cern.ch/work/c/chasco/FINISH_TMVA_XML/Run"+Combo_string+"/D4"+suff+"\n")
	bashprocess.write("python Evaluation_S_ZH105.py\n")
	bashprocess.write("python Evaluation_S_ZH115.py\n")
	bashprocess.write("python Evaluation_S_ZH125.py\n")
	bashprocess.write("python Evaluation_S_ZH150.py\n")
	bashprocess.write("python Evaluation_S_ZH135.py\n")
	bashprocess.write("python Evaluation_S_ZH145.py\n")
	# bashprocess.write("cd /tmp/chasco/INIT/HADD/TMVA/Trees"+suff+"/ZH_vs_nonZH/\n")
	...
	bashprocess.write("cp /tmp/chasco/INIT/HADD/TMVA/Trees"+suff+"/ZH105_vs_ALL/ZH115_vs_ALL/ZH125_vs_ALL/ZH150_vs_ALL/ZH135_vs_ALL/ZH145_vs_ALL/*.root /afs/cern.ch/work/c/chasco/FINISH_TMVA/Trees"+suff+Combo_string+"/\n")
	bashprocess.close()
