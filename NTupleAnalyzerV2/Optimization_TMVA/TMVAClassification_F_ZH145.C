...
factory->AddVariable("BDTZH145",'F');

factory->AddVariable("LikelihoodZH145",'F');
...
factory->AddVariable("LikelihoodZZ",'F');
   if (ReadDataFromAsciiIFormat) {
      ...
      TTree *signal_F_ZH145     = (TTree*)input_F_ZH145->Get("tmvatree");
      ...
      factory->AddSignalTree    ( signal_F_ZH145,     1.0     );
      ...
      //    factory->AddSignalTree( signal_F_ZH145TrainingTree, signal_F_ZH145TrainWeight, "Training" );

      //    factory->AddSignalTree( signal_F_ZH145TestTree,     signal_F_ZH145TestWeight,  "Test" );
