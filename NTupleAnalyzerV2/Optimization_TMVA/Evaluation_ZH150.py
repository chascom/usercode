...
fdir = directory + '/ZH105_vs_ZZ/ZH115_vs_ZZ/ZH125_vs_ZZ/' #Where your root files are kept
tag = 'ZH150_vs_ZZ'  # Tag to name your new directory of root files. DO NOT LEAVE BLANK
...
signal_tag = 'ZH150' # This identifies which files are signal. Should be in each signal file name above. 
