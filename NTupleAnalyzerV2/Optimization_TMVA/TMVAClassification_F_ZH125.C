...
factory->AddVariable("BDTZH125",'F');

factory->AddVariable("LikelihoodZH125",'F');
...
factory->AddVariable("LikelihoodZZ",'F');
   if (ReadDataFromAsciiIFormat) {
      ...
      TTree *signal_F_ZH125     = (TTree*)input_F_ZH125->Get("tmvatree");
      ...
      factory->AddSignalTree    ( signal_F_ZH125,     1.0     );
      ...
      //    factory->AddSignalTree( signal_F_ZH125TrainingTree, signal_F_ZH125TrainWeight, "Training" );

      //    factory->AddSignalTree( signal_F_ZH125TestTree,     signal_F_ZH125TestWeight,  "Test" );
