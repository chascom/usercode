...
factory->AddVariable("TransMass2",'F');
...
factory->AddVariable("CScostheta",'F');
   if (ReadDataFromAsciiIFormat) {
      ...
      TTree *signal_ZZ     = (TTree*)input_ZZ->Get("tmvatree");
      ...
      factory->AddSignalTree    ( signal_ZZ,     1.0     );
      ...
      //    factory->AddSignalTree( signal_ZZTrainingTree, signal_ZZTrainWeight, "Training" );

      //    factory->AddSignalTree( signal_ZZTestTree,     signal_ZZTestWeight,  "Test" );
