...
Float_t BDTZH125;
reader->AddVariable("BDTZH125",&BDTZH125);

Float_t LikelihoodZH125;
reader->AddVariable("LikelihoodZH125",&LikelihoodZH125);
...
theTree->SetBranchAddress( " BDTZH125", &BDTZH125);

theTree->SetBranchAddress( " LikelihoodZH125", &LikelihoodZH125);
