...
Float_t BDTZH150;
reader->AddVariable("BDTZH150",&BDTZH150);

Float_t LikelihoodZH150;
reader->AddVariable("LikelihoodZH150",&LikelihoodZH150);
...
theTree->SetBranchAddress( " BDTZH150", &BDTZH150);

theTree->SetBranchAddress( " LikelihoodZH150", &LikelihoodZH150);
