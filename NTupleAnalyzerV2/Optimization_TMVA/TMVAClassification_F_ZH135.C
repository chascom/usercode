...
factory->AddVariable("BDTZH135",'F');

factory->AddVariable("LikelihoodZH135",'F');
...
factory->AddVariable("LikelihoodZZ",'F');
   if (ReadDataFromAsciiIFormat) {
      ...
      TTree *signal_F_ZH135     = (TTree*)input_F_ZH135->Get("tmvatree");
      ...
      factory->AddSignalTree    ( signal_F_ZH135,     1.0     );
      ...
      //    factory->AddSignalTree( signal_F_ZH135TrainingTree, signal_F_ZH135TrainWeight, "Training" );

      //    factory->AddSignalTree( signal_F_ZH135TestTree,     signal_F_ZH135TestWeight,  "Test" );
