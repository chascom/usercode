...
Float_t CScostheta;
reader->AddVariable("CScostheta",&CScostheta);

Float_t ZRapidity;
reader->AddVariable("ZRapidity",&ZRapidity);

Float_t phil2met;
reader->AddVariable("phil2met",&phil2met);

Float_t ZL1_Boost;
reader->AddVariable("ZL1_Boost",&ZL1_Boost);

Float_t mass;
reader->AddVariable("mass",&mass);

Float_t Theta_lab;
reader->AddVariable("Theta_lab",&Theta_lab);

Float_t REDmet;
reader->AddVariable("REDmet",&REDmet);
...
//      reader->AddSpectator( "Category_cat3 := (var3>0)&&(var4>=0)", &Category_cat3 );
 ...
 float nonsense =0;
   ...
   //   
   TFile *input(0);
   TString fname = "/tmp/chasco/INIT/HADD/TMVA/Trees_FUSION2//Data7TeV_DoubleElectron2011B_0.root";   
...
theTree->SetBranchAddress( " CScostheta", &CScostheta);

theTree->SetBranchAddress( " ZRapidity", &ZRapidity);

theTree->SetBranchAddress( " phil2met", &phil2met);

theTree->SetBranchAddress( " ZL1_Boost", &ZL1_Boost);

theTree->SetBranchAddress( " mass", &mass);

theTree->SetBranchAddress( " Theta_lab", &Theta_lab);

theTree->SetBranchAddress( " REDmet", &REDmet);
