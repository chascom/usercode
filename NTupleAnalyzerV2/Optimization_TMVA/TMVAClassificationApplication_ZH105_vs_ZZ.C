...
//      reader->AddSpectator( "Category_cat3 := (var3>0)&&(var4>=0)", &Category_cat3 );
 ...
 float nonsense =0;
   ...
   //   
   TFile *input(0);
   TString fname = "/tmp/chasco/INIT/HADD/TMVA/Trees_FUSION2/ZZ_vs_nonZZ//Data7TeV_DoubleElectron2011B_0.root";   
...
theTree->SetBranchAddress( " REDmet", &REDmet);
   ...
   std::vector<Float_t> vecVar(3); // vector for EvaluateMVA tests
