...
discriminatingvariables = ['BDTZH125','LikelihoodZH125','BDTZZ','LikelihoodZZ'] #Discriminating variables, in order, used for the TMVA
...
fdir = directory + '/ZH105_vs_ALL/ZH115_vs_ALL/' #Where your root files are kept
tag = 'ZH125_vs_ALL'  # Tag to name your new directory of root files. DO NOT LEAVE BLANK
...
signal_tag = 'F_ZH125' # This identifies which files are signal. Should be in each signal file name above. 
