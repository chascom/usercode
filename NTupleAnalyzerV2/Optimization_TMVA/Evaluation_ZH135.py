...
fdir = directory + '/ZH105_vs_ZZ/ZH115_vs_ZZ/ZH125_vs_ZZ/ZH150_vs_ZZ/' #Where your root files are kept
if TeV8:
	fdir = fdir.replace('ZH150_vs_ZZ/','')
tag = 'ZH135_vs_ZZ'  # Tag to name your new directory of root files. DO NOT LEAVE BLANK
