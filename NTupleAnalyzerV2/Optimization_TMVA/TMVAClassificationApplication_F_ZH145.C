...
Float_t BDTZH145;
reader->AddVariable("BDTZH145",&BDTZH145);

Float_t LikelihoodZH145;
reader->AddVariable("LikelihoodZH145",&LikelihoodZH145);
...
theTree->SetBranchAddress( " BDTZH145", &BDTZH145);

theTree->SetBranchAddress( " LikelihoodZH145", &LikelihoodZH145);
