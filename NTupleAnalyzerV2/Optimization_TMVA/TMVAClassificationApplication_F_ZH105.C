...
Float_t BDTZH105;
reader->AddVariable("BDTZH105",&BDTZH105);

Float_t LikelihoodZH105;
reader->AddVariable("LikelihoodZH105",&LikelihoodZH105);
...
theTree->SetBranchAddress( " BDTZH105", &BDTZH105);

theTree->SetBranchAddress( " LikelihoodZH105", &LikelihoodZH105);
