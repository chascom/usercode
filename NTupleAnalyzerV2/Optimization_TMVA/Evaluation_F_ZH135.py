...
discriminatingvariables = ['BDTZH135','LikelihoodZH135','BDTZZ','LikelihoodZZ'] #Discriminating variables, in order, used for the TMVA
...
signal_tag = 'F_ZH135' # This identifies which files are signal. Should be in each signal file name above. 
