...
factory->AddVariable("REDmet",'F');
   if (ReadDataFromAsciiIFormat) {
      ...
      TTree *signal_ZH150     = (TTree*)input_ZH150->Get("tmvatree");
      ...
      factory->AddSignalTree    ( signal_ZH150,     1.0     );

      factory->AddBackgroundTree( background_ZZ, 1.0 );


      // To give different trees for training and testing, do as follows:
      //    factory->AddSignalTree( signal_ZH150TrainingTree, signal_ZH150TrainWeight, "Training" );

      //    factory->AddSignalTree( signal_ZH150TestTree,     signal_ZH150TestWeight,  "Test" );
