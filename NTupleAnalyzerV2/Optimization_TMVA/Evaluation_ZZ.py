...
#discriminatingvariables = ['Mass_Z','CS_cosangle','Pt_L2','L1_L2_cosangle','DeltaPhi_ZH','Z_rapidity_z','redMETCMS_combo_STAND','THRUST_2D','TransMass_MET_L2','PFMET_PT'] #Discriminating variables, in order, used for the TMVA
...
fdir = directory #'/tmp/chasco/INIT/HADD/TMVA/' #Where your root files are kept
tag = 'ZZ_vs_nonZZ'  # Tag to name your new directory of root files. DO NOT LEAVE BLANK
...
signal_tag = 'ZZ' # This identifies which files are signal. Should be in each signal file name above. 
