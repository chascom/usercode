...
Float_t TransMass2;
reader->AddVariable("TransMass2",&TransMass2);
...
//      reader->AddSpectator( "Category_cat3 := (var3>0)&&(var4>=0)", &Category_cat3 );
 ...
 float nonsense =0;
   ...
   //   
   TFile *input(0);
   TString fname = "/tmp/chasco/INIT/HADD/TMVA/Trees_FUSION2//Data7TeV_DoubleMu2011B_1.root";   
...
theTree->SetBranchAddress( " TransMass2", &TransMass2);
...
theTree->SetBranchAddress( " CScostheta", &CScostheta);
   ...
   std::vector<Float_t> vecVar(6); // vector for EvaluateMVA tests
