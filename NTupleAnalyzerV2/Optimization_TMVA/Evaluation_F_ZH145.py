...
discriminatingvariables = ['BDTZH145','LikelihoodZH145','BDTZZ','LikelihoodZZ'] #Discriminating variables, in order, used for the TMVA
...
fdir = directory + '/ZH105_vs_ALL/ZH115_vs_ALL/ZH125_vs_ALL/ZH150_vs_ALL/ZH135_vs_ALL/' #Where your root files are kept
if TeV8:
	fdir = fdir.replace('ZH150_vs_ALL/','')
tag = 'ZH145_vs_ALL'  # Tag to name your new directory of root files. DO NOT LEAVE BLANK
...
signal_tag = 'F_ZH145' # This identifies which files are signal. Should be in each signal file name above. 
