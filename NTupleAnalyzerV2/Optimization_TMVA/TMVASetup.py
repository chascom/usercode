...
# Background root files without the .root
	...
	#backgroundtags = ['DYJetsToLL','TTJets','WW','WZ']
	backgroundtags = ['DYJetsToLL','TTJets','WW','WZ','SingleT_t','SingleTbar_t']
	if TeV8:
		backgroundtags = ['DYJetsToLL_50toInf','TTJets','WW','WZ','SingleT_t','SingleTbar_t']
	#backgroundtags = ['DYJetsToLL','SingleT','Jets','WW','WZ']
...
# Variables you will optimize with
	...
	if TeV8:
		discriminatingvariables = [discriminatingvariable_set1,discriminatingvariable_set2,discriminatingvariable_set3,discriminatingvariable_set4,discriminatingvariable_set5]
...
# Signal root files will begin with the following. Can be multiple
	...
	if TeV8:
		signaltags = ['ZH105','ZH115','ZH125','ZH135','ZH145']
# preselections correspond to above signal types
...
# Background root files without the .root
	...
	#backgroundtags = ['DYJetsToLL','SingleT','Jets','WW','WZ','ZZ']
	backgroundtags = ['DYJetsToLL','TTJets','WW','WZ','SingleT_t','SingleTbar_t','ZZ']
	if TeV8:
		backgroundtags = ['DYJetsToLL_50toInf','TTJets','WW','WZ','SingleT_t','SingleTbar_t','ZZ']
...
# Variables you will optimize with
	...
	if TeV8:
		discriminatingvariables = [['BDTZH105','LikelihoodZH105','BDTZZ','LikelihoodZZ'],['BDTZH115','LikelihoodZH115','BDTZZ','LikelihoodZZ'],['BDTZH125','LikelihoodZH125','BDTZZ','LikelihoodZZ'],['BDTZH135','LikelihoodZH135','BDTZZ','LikelihoodZZ'],['BDTZH145','LikelihoodZH145','BDTZZ','LikelihoodZZ']]
# Naming convention for output files
	tagname = 'test'
# Tree name where variables in root file are stored
	treename = String_TreeName
...
# Signal root files will begin with the following. Can be multiple
	...
	if TeV8:
		signaltags = ['F_ZH105','F_ZH115','F_ZH125','F_ZH135','F_ZH145']
# preselections correspond to above signal types
	preselections = [preselection,preselection,preselection,preselection,preselection,preselection]
# MVA Methods to employ
	methods = ['BDT','Likelihood']
