...
factory->AddVariable("REDmet",'F');
   if (ReadDataFromAsciiIFormat) {
      ...
      TTree *signal_ZH125     = (TTree*)input_ZH125->Get("tmvatree");
      ...
      factory->AddSignalTree    ( signal_ZH125,     1.0     );

      factory->AddBackgroundTree( background_ZZ, 1.0 );


      // To give different trees for training and testing, do as follows:
      //    factory->AddSignalTree( signal_ZH125TrainingTree, signal_ZH125TrainWeight, "Training" );

      //    factory->AddSignalTree( signal_ZH125TestTree,     signal_ZH125TestWeight,  "Test" );
