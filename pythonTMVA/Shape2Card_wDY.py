...
def MakeCard(lep,afile,adir,siglist,intlist,numlist,length,dat,stats):
	...
	for st in stats:
		if ("ZH" in st):
			tablelist.write(st.replace("Up","").replace("ZH125_","").replace("ZH135_","").replace("ZH145_","") + "\tshape" + "\t1.0" + "\t-"*(length-1) + "\n")
		if ("WZ" in st):
...
sdir = "/afs/cern.ch/work/c/chasco/CMSSW_5_3_11/src/CMGTools/HtoZZ2l2nu/TMVA/OUT_FFFF125/"#_cutscan/"
