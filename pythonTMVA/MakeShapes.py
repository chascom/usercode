...
redmetcuts = [95]#[70,75,80,85]#[95,97,100,105]#110]#,100,105,107,110]
phicuts = [1.5,2.2,2.7]#,2.4,2.6,2.8]#,2.3]#[1.8,1.9,2.0,2.1]
...
for redmetcut in redmetcuts:
	for phicut in phicuts:
		...
		n="8"
		print n, "TeV", "="*20
		inputdir = "/afs/cern.ch/work/c/chasco/JUL8_"+n+"/" #v4D, v4E
