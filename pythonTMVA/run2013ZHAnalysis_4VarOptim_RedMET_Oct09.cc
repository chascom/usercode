...
*/
  ...
  ///////////////////////////////////// TREE VARIABLES
      ...
      bool passFullSelection (isSameFlavor && passZmass && passLocalJetveto && pass3dLeptonVeto && (redMet.pt() > 110) && passLocalBalanceCut && passLocalBveto && (dphiZmet > 2.6));// && (zll.pt() > 50.0));// && passRedMet);//(redMet.pt() > 70));
