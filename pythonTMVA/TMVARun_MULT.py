...
def TrainingTesting(inputdir,inputfiles,inputtree,weightexpression,sigcut,bgcut,methods,RR):
  ...
  if "BDT" in methods:
    bdttrees = ['500','600','800']#['1500','2000','2500']#,'1800','2000','2200']#,'2500','2700']#['2300','2400','2500','2600','2700']#['2800','3000','3200']#,'3000','4000','5000']#,'2000','3000']#,'1000','4000']#,'1000']#,'200','500','1000']
    bdtdepth = ['3','4','5']#,'4']#,'4']#,'5']
    for tt in bdttrees:
      for dd in bdtdepth:
...
SBpairs += [["ZH125.root","BKGDandZZ.root",'v5',['blowout','DeltaR','l2pt','phil2met','metPzptOVERl1ptPl2pt']]]
